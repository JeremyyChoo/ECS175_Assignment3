...
class ShadedObject3D extends Object3D { 
    ...
    createVAO( gl, shader )
    {
        ...
        if (location >= 0) {
            ...
            gl.enableVertexAttribArray(location);
            gl.vertexAttribPointer(location, 3, gl.FLOAT, false, num_total_components * Float32Array.BYTES_PER_ELEMENT, 0);
        }
        ...
        if (location >= 0) {
            ...
            gl.enableVertexAttribArray(location);
            gl.vertexAttribPointer(location, 3, gl.FLOAT, false, num_total_components * Float32Array.BYTES_PER_ELEMENT, 3 * Float32Array.BYTES_PER_ELEMENT);
        }
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            gl.enableVertexAttribArray(location);
            gl.vertexAttribPointer(location, 3, gl.FLOAT, false, num_total_components * Float32Array.BYTES_PER_ELEMENT, 6 * Float32Array.BYTES_PER_ELEMENT);
        }
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            gl.enableVertexAttribArray(location);
            gl.vertexAttribPointer(location, 2, gl.FLOAT, false, num_total_components * Float32Array.BYTES_PER_ELEMENT, 9 * Float32Array.BYTES_PER_ELEMENT);
        }
